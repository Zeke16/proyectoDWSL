...
$proyectoEmp = " SELECT p.id_postulacion_universidad, p.id_estado_postulacion, ep.estado_postulacion,
pe.id_proyecto_universidad, pe.nombre_proyecto, pe.descripcion, pe.fecha_inicio, 
...
inner join tbl_proyecto_universidad as pe on p.id_proyecto_universidad = pe.id_proyecto_universidad
...
WHERE id_estudiante = " . $id_estudiante . " AND p.id_proyecto_universidad = " . $id_universidad;
//echo $proyectoEmp;
