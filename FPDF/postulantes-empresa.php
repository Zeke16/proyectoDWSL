...
$proyectoEmp = "Select p.id_proyecto_empresa, p.nombre_proyecto, p.descripcion, p.fecha_inicio, 
p.fecha_final_estimada, p.fecha_finalizado, e.nombre_empresa, tp.nombre_tipo_proyecto, c.nombre_carrera, ep.estado
from tbl_proyecto_empresas as p 
inner join tbl_empresas as e on p.id_empresa = e.id_empresa
...
where id_proyecto_empresa = "  . $id_empresa;
...
$postulante = "
            Select 
                p.id_postulacion_empresa, p.id_estado_postulacion, ep.estado_postulacion,
...
$pdf->Cell(20, 10,  utf8_decode($proyectos[0]->id_proyecto_empresa), 1, 0, 'C', 1);
