            ...
            <div class="col-md-6">
                <div class="card" style="width: 40rem;">
                    <div class="card-header d-flex justify-content-start" id="header-logEst">
                        <img class="mt-2" src="http://localhost/proyectodwsl/assets/icon/user-pen-solid.svg" width="40xp" height="40px" id="emp" alt="">&nbsp;&nbsp;
                        <h2 class="card-title mt-2">Inicio de sesion</h2>
                    </div>
                    <div class="card-body" id="body-logEst">
                        <form method="POST">
                            <label>Escribe tu correo electrónico:</label><br>
                            ...
                            <input class="form-control mt-2" type="text" hidden name="tabla" value="tbl_estudiantes" />
                            <input class="rounded-pill form-control" type="submit" name="btnIngresar" id="btnEnviarEst" value="Ingresar" /><br>
                            <a href="http://localhost/proyectodwsl/modules/estudiantes/views/form-register.php" class="btn form-control border-dark btn-primary rounded-pill">Crear una nueva cuenta </a><br>
                        </form>
                    </div>
                </div>
            </div>
