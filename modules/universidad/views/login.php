...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "Select * from " . $tabla . " where (nombre_usuario = '" . $nombre . "' OR correo = '" . $nombre . "') and password = '" . $pass . "'";
            ...
            <div class="col-md-6">
                <div class="card" style="width: 40rem;">
                    <div class="card-header d-flex justify-content-start" id="header-logU">
                        <img src="http://localhost/proyectodwsl/assets/img/logo.png" width="50xp" height="50px" alt="">
                        <h2 class="card-title mt-2">Inicio de sesion</h2>
                    </div>
                    <div class="card-body" id="body-logU">
                        <form method="POST" action="login.php">
                            <label>Escribe tu usuario o correo electrónico:</label><br>
                            ...
                            <input class="form-control mt-2" type="text" hidden name="tabla" value="tbl_super_administrador" />
                            <button class="rounded-pill form-control" id="btnEnviarU" type="submit">Ingresar</button>
                            <input class="rounded-pill form-control" hidden type="submit" name="btnIngresar" value="Ingresar" />
                        </form>
                    </div>
                </div>
            </div>
